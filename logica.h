...
void avancar_nivel(EstadoJogo *jogo);                      // Para vencer o combate e ir pro próximo 
void gerar_inimigos(Inimigo *ini);                         // Para criar o inimigo (fraco ou forte) e sortear sua vida
