//CÓDIGO DE COMPILAÇÃO NO VSCODE: gcc main.c renderer.c utils.c input.c logica.c -o game -lallegro -lallegro_image -lallegro_primitives -lallegro_font -lallegro_ttf -lm
